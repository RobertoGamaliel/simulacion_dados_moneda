function select(id){
	...
	if(selection==3){
		...
		<button type="button" class="btn btn-dark shadow mt-3 mb-5" onclick="f1()" id="actionButton">COMENZAR SIMULACIÓN</button>
		<div class="mb-5">
		  <canvas id="myChart" width="700"  height="400" #chart>{{  chart  }}</canvas>
		</div>
		`;
	}else if(selection==2){
		document.getElementById("funcion").innerHTML=`
		...
		<img class="container shadow m-3 mb-5 justify-content-center align-items-center" id="dado1" src="dado5.png" width="100px">
		
		<button type="button" class="btn btn-dark shadow mt-3 mb-5" onclick="f2()" id="actionButton">COMENZAR SIMULACIÓN</button>
		<div class="mb-5">
		  <canvas id="myChart" width="400"  height="400" #chart>{{  chart  }}</canvas>
		</div>
		`;
	}else if(selection==1){
		document.getElementById("funcion").innerHTML=`
		...
		<button type="button" class="btn btn-dark shadow mt-5 mb-5" onclick="f3()" id="actionButton">COMENZAR SIMULACIÓN</button>
		<div class="mb-5">
		  <canvas id="myChart" width="400"  height="400" #chart>{{  chart  }}</canvas>
		</div>
		`;
